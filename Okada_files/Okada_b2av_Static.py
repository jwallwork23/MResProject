# This programme will need a netCDF function implemented for use
# in static cases

# You can view the output by simply using
# plt.contourf(X,Y,Z)

# This program was stripped of these functionalities for use in CX2
