...
def linear_form_1d(mu, mu_, eta, eta_, nu, ze, b, Dt, n=None):
...
def linear_form_2d(mu, mu_, eta, eta_, nu, ze, b, Dt, n=None):
...
def nonlinear_form(u, u_, eta, eta_, v, ze, b, Dt, n=None):
...
def linear_form(u, u_, eta, eta_, v, ze, b, Dt, n=None):
...
def adj_linear_form_1d(lm, lm_, le, le_, v, w, b, Dt, n=None):
...
def adj_linear_form_2d(lm, lm_, le, le_, w, xi, b, Dt, n=None):
    ...
    return L
                                                                                           # + J derivative term?
def adj_nonlinear_form(w, xi, n=None):   # TODO: Needs changing!
    '''Weak residual form of the nonlinear adjoint shallow water equations.'''
    L = ((le-le_) * xi - Dt * g * b * inner(lm, grad(xi)) + inner(lm-lm_, w) + Dt * inner(grad(le), w)) * dx
    return L                                                                                        # + J derivative term?

def adj_linear_form(lm, lm_, le, le_, w, xi, b, Dt, n=None):
